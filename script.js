document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    id: {
      ...
      'about-p2': 'Dengan pengalaman selama 1 tahun terakhir di industri ini, saya aktif memanfaatkan teknologi bertenaga AI untuk mempercepat alur kerja pembuatan kode (AI-assisted coding) tanpa mengabaikan pemahaman logika dasar. Saya berkomitmen untuk menghasilkan website yang cepat, memiliki kode yang bersih (clean code), dan mudah dipelihara.',
      ...
      'val3-title': 'Efisiensi & Kecepatan',
      'val3-desc': 'Memaksimalkan alat bantu kecerdasan buatan (AI) untuk mempercepat proses pembuatan produk berkualitas tinggi.',
    ...
    en: {
      ...
      'about-p2': 'With over 1 year of experience in this industry, I actively leverage AI-powered tools to accelerate development workflows (AI-assisted coding) while maintaining a strong grasp of core programming logic. I am committed to delivering clean, fast, and highly maintainable web applications.',
      ...
      'val3-title': 'Efficiency & Speed',
      'val3-desc': 'Maximizing artificial intelligence (AI) tools to accelerate the delivery of high-quality web applications.',
